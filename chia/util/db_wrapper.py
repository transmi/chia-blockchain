...
class DBWrapper2:
    ...
    async def add_connection(self, c: aiosqlite.Connection) -> None:
        # this guarnatees that reader connections can only be used for reading
    ...
    async def write_db(self) -> AsyncIterator[aiosqlite.Connection]:
        ...
        async with self._lock:
            ...
            try:
                ...
                # just restarts it at its initial state. We want to cancel it
                # here, so we release it as well
